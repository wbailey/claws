...
Gem::Specification.new do |gem|
  ...
  gem.description = '
    A command line tool that provides a configurable report on the status of
    all of your EC2 hosts and provides trivial ssh access for connectivity.
    Never copy and paste the public dns for a host again.
  '

  gem.authors  = 'Wes Bailey'
